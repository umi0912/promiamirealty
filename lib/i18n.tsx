...
export const DICT = {
  ...
  "home.agent.title": { en: "Meet Your Real Estate Broker", ru: "Познакомьтесь с вашим брокером" },
  ...
  // search page
  "search.title": { en: "Real Estate & Homes for Sale", ru: "Недвижимость и дома на продажу" },
  "search.results": { en: "results", ru: "объектов" },
  "search.searching": { en: "Searching…", ru: "Ищем…" },
  "search.placeholder": { en: "City, neighborhood, ZIP code…", ru: "Город, район, ZIP…" },
  "search.forSale": { en: "For sale", ru: "В продаже" },
  "search.comingSoon": { en: "Coming soon", ru: "Скоро в продаже" },
  "search.forSaleSoon": { en: "For sale + soon", ru: "Продажа + скоро" },
  "search.anyPrice": { en: "Any price", ru: "Любая цена" },
  "search.minPrice": { en: "Min price", ru: "Цена от" },
  "search.maxPrice": { en: "Max price", ru: "Цена до" },
  "search.allTypes": { en: "All property types", ru: "Все типы" },
  "type.condo": { en: "Condo", ru: "Кондо" },
  "type.house": { en: "House", ru: "Дом" },
  "type.townhouse": { en: "Townhouse", ru: "Таунхаус" },
  "type.land": { en: "Land", ru: "Земля" },
  "search.allBeds": { en: "All beds", ru: "Спальни: любые" },
  "search.beds": { en: "beds", ru: "спал." },
  "search.allBaths": { en: "All baths", ru: "Санузлы: любые" },
  "search.baths": { en: "baths", ru: "с/у" },
  "search.list": { en: "List", ru: "Список" },
  "search.map": { en: "Map", ru: "Карта" },
  "search.loadMore": { en: "Load more", ru: "Показать ещё" },
  "search.noMatch": { en: "No listings match — adjust filters.", ru: "Ничего не найдено — измените фильтры." },
  "search.active": { en: "Active", ru: "Активно" },
  "search.coming": { en: "Coming soon", ru: "Скоро" },

  // listing detail
  "listing.back": { en: "← Back to search", ru: "← Назад к поиску" },
  "listing.loading": { en: "Loading listing…", ru: "Загрузка объекта…" },
  "listing.notFound": { en: "Listing not found.", ru: "Объект не найден." },
  "listing.beds": { en: "Beds", ru: "Спальни" },
  "listing.baths": { en: "Baths", ru: "Санузлы" },
  "listing.estPayment": { en: "Est. payment", ru: "Платёж ~" },
  "listing.pricePerSqft": { en: "Price per sqft", ru: "Цена за sqft" },
  "listing.builtIn": { en: "Built in", ru: "Год постройки" },
  "listing.propSize": { en: "Property size", ru: "Площадь" },
  "listing.propType": { en: "Property type", ru: "Тип" },
  "listing.about": { en: "About this home", ru: "Об объекте" },
  "listing.location": { en: "Location", ru: "Расположение" },
  "listing.additional": { en: "Additional information", ru: "Дополнительно" },
  "listing.estimate": { en: "Estimate your monthly payment", ru: "Рассчитайте месячный платёж" },
  "listing.similar": { en: "Similar properties", ru: "Похожие объекты" },
  "listing.bookTour": { en: "Book a tour", ru: "Записаться на показ" },
  "listing.call": { en: "Call", ru: "Позвонить" },
} as const;
