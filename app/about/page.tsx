    ...
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "120px 24px 0" }}>
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }} className="agrid">
        <div>
          ...
          <h1 style={{ fontSize: "clamp(28px,5vw,52px)", margin: "0 0 20px", lineHeight: 1.05 }}>{AGENT.name}</h1>
        ...
        <div style={{ aspectRatio: "4/5", borderRadius: 20, background: "var(--surface-2)", backgroundImage: `url("${AGENT.photo}"), url(https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=800&q=80)`, backgroundSize: "cover", backgroundPosition: "center top" }} />
      </div>
